...
**Python (recommended for most users)** — prebuilt binary via [maturin](https://www.maturin.rs/); no Rust required:

```bash
pip install zerum
# or: pipx install zerum
# or: uv tool install zerum
zerum check .
```
...
Full install guide: [docs/packaging/INSTALL.md](docs/packaging/INSTALL.md).
...
CI runs lint, tests, coverage, regression, and a maturin packaging smoke build on push/PR (see `.github/workflows/ci.yml`).
...
Packaging docs: [docs/packaging/](docs/packaging/).
...
See [CHANGELOG.md](CHANGELOG.md). Release notes: [v0.1.0](docs/RELEASE_v0.1.0.md) · [v0.2.0](docs/RELEASE_v0.2.0.md) · [v0.4.0](docs/RELEASE_v0.4.0.md). Publishing: [crates.io](docs/RELEASING.md) · [PyPI](docs/packaging/RELEASING_PYPI.md) · [v0.4.0 checklist](docs/DISTRO_CLOSURE_v0.4.0.md).
